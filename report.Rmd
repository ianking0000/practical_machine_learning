...
As we can see the out-of-sample accuracy is only `r ainfo3`, which is fairly low. This is reasonable since without pruning/bootstrp the decision tree tends to have overfitting prolbmes so its out-of-sample error is large.   
